    ...
    created(){
            ...
            if(this.authUser.uuid == undefined){
                this.getUser().then(()=>{
                    ...
                    this.fetchStock(this.authUser.uuid).then((res)=>{
                        this.stocks = res.data.data
                        this.stockLoading = false
                    })

                    this.statsLoading = true
                    this.fetchStats(this.authUser.uuid).then((res)=>{
                        this.stats = res.data.data
                        this.statsLoading = false
                    })

                    this.purchasesLoading = true
                    this.getStockistPurchases(this.authUser.uuid).then(()=>{
                        //this.stocks = res.data.data
                        this.purchasesLoading = false
                    })

                    this.stockDetailsLoading = true
                    this.fetchStockDetails(this.authUser.uuid).then(()=>this.stockDetailsLoading=false)

                    this.rebateLoading = true
                    this.fetchRebateEarnings(this.authUser.uuid).then(()=>{
                        //this.stocks = res.data.data
