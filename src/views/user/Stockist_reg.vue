    ...
    <div>
        <div class="">
                            ...
                            <div class="col-12">
                                <div class="card shadow" style="background-color: transparent">
                                    <div class="card-body" style="background-color: transparent">
                                        <div class="text-center mb-3"><img src="/assets/img/logo1.png"  width="200px" Height="auto"></div>
                                        <h6 class="font-weight-bold text-green">To All Prospective Stockists of REEZ GLOBAL NATURAL HEALTH LTD</h6>
                                        <p class="s-14"> We hereby provide this formal Disclaimer to all individuals and entities seeking to register 
                                            as stockists with REEZ GLOBAL NATURAL HEALTH LTD (“the Company”). This document outlines essential 
                                        ...
                                        <h6 class="font-weight-bold text-green">Payments and Financial Transactions</h6>
                                        <p class="s-14"> All payments related to registration, upgrades, and repurchase of products must be made 
                                            exclusively to REEZ GLOBAL NATURAL HEALTH LTD’s official bank accounts. The Company bears no responsibility 
                                        ...
                                        <h6 class="font-weight-bold text-green">Collection of Products</h6>
                                        ...
                                        <h6 class="font-weight-bold text-green">Termination of Stockist Agreement</h6>
                                        <p class="s-14">If a stockist chooses to terminate their agreement with REEZ GLOBAL NATURAL HEALTH LTD, the Company 
                                        ...
                                        <h6 class="font-weight-bold text-green">Exclusion of Liability</h6>
                                        <p class="s-14">REEZ GLOBAL NATURAL HEALTH LTD shall not be held liable for any financial loss, misrepresentation, 
                                        ...
                                        <h6 class="font-weight-bold text-green">Binding Agreement</h6>
                                        <p class="s-14">By registering as a stockist with REEZ GLOBAL NATURAL HEALTH LTD, you agree to abide by the terms 
                                            and conditions set forth in this Disclaimer, as well as any subsequent policies communicated by the Company.
                                        </p><br>
                                        <p class="s-14">This Disclaimer is issued under the authority of the management of REEZ GLOBAL NATURAL HEALTH LTD 
            ...
            <div class="row ">	
                ...
                <div class="col-md-4">
                    <div class="card mr-3 shadow-lg" style="background-color: #ded8c7">
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div>
                                    <span class="text-green" id="d1" style="font-size:10px">Store name</span>
                                    <h6 class="font-weight-bold text-green" id="d1">{{ form.store_name }}</h6>
                                    <span class="text-green" id="d1" style="font-size:10px">Stockist Address <Area></Area></span>
                                    <h6 class="font-weight-bold text-green " id="d1">{{ form.store_address }}</h6>
                                    <span class="text-green" id="d1" style="font-size:10px">State</span>
                                    <h6 class="font-weight-bold text-green " id="d1">{{ form.store_state }}</h6>
                                    <span class="text-green"  id="d1" style="font-size:10px">Stockist Package</span>
                                    <h6 class="font-weight-bold text-green" id="d1">{{ getPackageName(form.package_id) }}</h6>
                                    <span class="text-green" id="d1" style="font-size:10px">Contact</span>
                                    <h6 class="font-weight-bold text-green " id="d1">{{ form.store_phone }}</h6>
                                    <span class="text-green" id="d1" style="font-size:10px">Signee</span>
                                    <h6 class="font-weight-bold text-green" id="d1">{{ form.referrer }}</h6>
            ...
            <div class="row">
                ...
                <template v-else>
                    <div v-for="bank,i in banks" class="col-md-4" :key="i">
                        <div class="card shadow1 rounded" style="background-color: transparent">
                            <div class="card-body">
                                <div class="d-flex justify-content-center">
                                    <div class="text-center mt-3 pb-4">  <img src="/assets/img/bankinghall2a.png" width="auto" height="150px"></div>
