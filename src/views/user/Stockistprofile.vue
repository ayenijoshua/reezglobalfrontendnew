                                ...
                                <div class="card-body">
                                    ...
                                    <div v-else class="d-flex justify-content-center">
                                        ...
                                        <div class="card-body text-center">
                                            ...
                                            <span class="text-green" id="d1" style="font-size:10px">Package Price</span>
                ...
                <div class="col-md-9 col-sm-12"> 
                    <div >
                        <div >
                            ...
                            <div class="d-flex justify-content-center"><p class="font-weight-bold green-text">Cancellation of Your stockist Status will be reviewed and approved or declined by the admin within 72 hours.</p></div>
                            <div class="d-flex justify-content-center">
                                <button  type="submit" class="btn btn-sm btn-danger "><i class="icon-cancel mr-2"></i>Cancel Stockist Status</button>
                            </div>
                        </div>
                    </div>
                </div>   
...
export default{
    ...
    methods:{
        ...
        upgradeStockist(){
            ...
            this.upgrade({id:this.stockist.id,data:form})
        }
