                    ...
                    <div class="col-lg-7 mx-md-auto">
                        <div class="text-center">
                           <a href="">
                            ...
                            <h3 class="p-t-b-20 text-white">Email Confirmation</h3>
                            <p class="p-t-b-20 text-white">Please confirm you Email, by entering the code send to your eamil address</p>
                            <button class="btn btn-success btn-lg" @click="resendEmail()">Resend Verification Code</button>
                        </div>
                        <br/>
