                                ...
                                <tbody>
                                    ...
                                    <template v-else>
                                        <tr v-if="referralBonusSetting.length == 0">
                                            <td colspan="13">
                                                <div class="alert alert-info text-center">There are no Referral bonus settings</div>
                                            </td>
                                        </tr>
                                        <template v-else>
                                    ...
                                    <div class="form-row mb-3">
                                        <div class="col-md-12">
                                            <div class="input-group">
                                                ...
                                                <input v-model="matchingBonusPV.matching_bonus_total_pv" required  type="number" class="form-control r-0 light s-12" placeholder="Bonus total PV"  style="background-color:#ded8c7; border: 1px solid #2E671A">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-row mb-3">
                                        <div class="col-md-12">
                                            <div class="input-group">
                                                ...
                                                <input v-model="matchingBonusPercent.matching_bonus_percent"  required type="number" class="form-control r-0 light s-12" placeholder="Bonus %"  style="background-color:#ded8c7; border: 1px solid #2E671A">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-row ml-1">
                                    ...
                                    <div class="form-row mb-3">
                                        <div class="col-md-12">
                                            <div class="input-group">
                                                ...
                                                <input v-model="repurchaseBonus.repurchase_bonus_percentage" required type="number" class="form-control r-0 light s-12" placeholder="Bonus %"  style="background-color:#ded8c7; border: 1px solid #2E671A">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-row ml-1">
                                    ...
                                    <div class="form-row mb-3">
                                        <div class="col-md-12">
                                            <div class="input-group">
                                                ...
                                                <input v-model="matchingBonusFrequency.matching_bonus_frequency" required type="number" class="form-control r-0 light s-12" placeholder="Bonus Frequency"  style="background-color:#ded8c7; border: 1px solid #2E671A">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-row ml-1">
