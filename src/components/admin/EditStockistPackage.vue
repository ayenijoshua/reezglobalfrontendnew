<template>
    <div class="card border-0 justify-content-center" style="background-color: #ecf0f1">
        <div class="card-body rounded" style="background-color: #ecf0f1"> 
            ...
            <h6 class="mt-1 s-8 font-weight-bold text-green">OFFICIAL STOCKIST REGISTRATION PACKAGE RATES<br><small> Edit preferred Registration Package Rates</small></h6></div>
            <form @submit.prevent="updatePackage()">
                <div class="card no-b  no-r">
                    <div class="card-body no-gutters" style="background-color: #ecf0f1">
                        ...
                        <span class="btn btn-sm btn-success btn-lg" v-if="sending">...</span>
...
import { mapActions, mapState } from 'vuex'
 ...
 export default{
    ...
    created(){
        ...
        this.form.pickup_amount = this.currPackage.pickup_amount
        this.form.value = this.currPackage.value
        this.form.sales_bonus_percentage = this.currPackage.sales_bonus_percentage
    },

    methods:{
        ...mapActions('stockistPackageStore',['update']),
